...
MODE = None
model_name = 'fk_sal1400_bs32_max'
...
def parse_args():
    ...
    parser.add_argument('--resume_model', type=str,
                        default='./checkpoints/ecssdplus_rkhs/mIoU_fk_lr1e-4_B32T_-0.291_75.39.pth') #'./checkpoints/acdc_csSTD/tz_std_Gausig01_0.000_59.03.pth'
...
def main(args):
    ...
    with torch.no_grad():
        ...
        if args.mode == 'val':
            ...
            #
            # print(' ')
            # print('Evaluation metric: mean value')
            # if cfg['dataset'] == 'pascal':
            #     print('Evaluation metric(class): [background, aeroplane, bicycle, bird, boat, bottle'
            #           ', bus, car, cat, chair, cow, diningtable, dog, horse, motorbike, person'
            #           ', pottedplant, sheep, sofa, train, tvmonitor]')
            # elif cfg['dataset'] == 'acdc':
            #     print('Evaluation metric(class): [background, RV, myo, LV]')
            #
            # print('meanIOU:', scores[0][0])
            # print('meanIOU(class):', scores[0][1:])
            # print('meanDICE:', scores[1][0])
            # print('meanDICE(class):', scores[1][1:])
            # print('meanPA:', scores[2][0])
            # print('meanPA(class):', scores[2][1:])
            # # print('mIOU:', scores[0][0], scores[0][4])
            # # print('mPA:', scores[2][0], scores[2][4])
            #
            # print(' ')
            #
            # print('mIOU:', mIOU * 100.0)
            # print('mIOU(class):', IOU * 100.0)
            # print('mDICE:', mDICE * 100.0)
            # print('mDICE(class):', DICE * 100.0)
            # print('mPA:', mPA * 100.0)
            # print('mPA(class):', PA * 100.0)
