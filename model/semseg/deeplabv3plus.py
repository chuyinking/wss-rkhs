...
import model.backbone.resnetwide as resnet #Original, import model.backbone.resnet as resnet    if use wide resnet101, import model.backbone.resnetwide as resnet
...
class DeepLabV3Plus(nn.Module):
    def __init__(self, cfg, aux=True):
        ...
        self.backbone = \
            resnet.__dict__[cfg['backbone']](cfg['pretrain_weight'], multi_grid=cfg['multi_grid'],
